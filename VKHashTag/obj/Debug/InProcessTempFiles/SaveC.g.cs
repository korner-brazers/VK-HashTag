...
namespace VKHashTag.Engine.Class.conf {
    
    
    [System.Runtime.InteropServices.ComVisible(false)]
    public partial class SaveC : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(SaveC).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(SaveC));
        ...
        private string FindResource() {
            string[] resources = typeof(SaveC).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".SaveC.g.xaml") || resource.Equals("SaveC.g.xaml"))) {
                    return resource;
                }
            }
