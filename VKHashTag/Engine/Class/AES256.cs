...
namespace VKHashTag.Engine.Class
{
    class AES256 : IDisposable
    {
        ...
        public AES256()
        {
            ...
            AESProvider.Key = (new PasswordDeriveBytes(Engine.Class.Iron.get, Encoding.ASCII.GetBytes(Engine.Class.Iron.get), "SHA1", 1000)).GetBytes(256 / 8);
        }
